            ...
            success:function (result) {
                ...
                if (result.success) {
                    ...
                    if (pageno == 1){
                        ...
                        contentBar+='<li><a href="#" onclick="queryPageUser('+(parseInt(pageno)-1)+')">上一页</a></li>';
                    }
                    ...
                    for (var i = 1 ; i <= page.totalno;i++){
                        contentBar +='<li';
                            ...
                            contentBar+='> <a href="#" onclick="queryPageUser('+i+')">'+i+'</a>';
                            contentBar+='</li>';
                    }
                    ...
                    if (pageno == page.totalno){
                        ...
                        contentBar+='<li><a href="#" onclick="queryPageUser('+(parseInt(pageno)+1)+')">下一页</a></li>';
                    }
